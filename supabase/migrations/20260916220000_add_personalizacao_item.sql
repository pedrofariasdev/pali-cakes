...
-- Coluna para guardar as opções/variantes do produto (ex.: sabores
-- disponíveis, cada um com nome e foto), usada pelo front-end e pelo painel
-- de administração de produtos.
alter table public.produtos
  add column if not exists opcoes jsonb not null default '{}'::jsonb;

-- Coluna para guardar personalizações do item (ex.: sabor escolhido),
-- usada pelo front-end quando o produto tem variantes.
alter table public.encomenda_itens
